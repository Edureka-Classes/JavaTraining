...
public class PredicateTest2 {
    public static void main (String[] args) {
        // -- a predicate to check whether a given number is greater than 10 or not
        ...
        System.out.println("Is a collection empty = " + p2.test(Arrays.asList(10, 20)));
        System.out.println("Is a collection empty = " + p2.test(Arrays.asList()));
    }
}
